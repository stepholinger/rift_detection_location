...
ax.plot(rift2_x,rift2_y,c="r",zorder=len(all_first_components)*10)

# plot station locations
ax.scatter(stat_x,stat_y,marker="^",c='black',zorder=count*10)
...
# add distance scale
#ax.plot(np.linspace(avg_stat_x-60000,avg_stat_x-80000,10),np.ones(10)*avg_stat_y-30000,c="k",zorder=len(all_first_components)*10)
